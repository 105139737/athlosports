...
$crate=0;
$data13 = mysqli_query($conn,"SELECT ((sum((opst+stin-stout)*rate))/sum(opst+stin-stout)) as prate,((sum((opst+stin-stout)*stk_rate))/sum(opst+stin-stout)) as stk_rate FROM main_stock WHERE pcd='$pcd' and dt<='$dt' and (opst+stin)>0 $brncd1  group by pcd ");
...
?>
<tr>
<td align="right" colspan="4"><font color="red" size="3"><b>Total : </b></font></td>
<td><font color="red" size="3"><b><?=$tstk;?></b></font></td>
