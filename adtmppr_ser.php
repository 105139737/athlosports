...
$query7="Select * from main_ser_slt where  prsl='$prnm' and eby='$user_currently_loged' and refno='$refno' and unit='$unit'";
...
$query21 = "INSERT INTO main_ser_slt (srtnm,total,disp,disa,cat,scat,prsl,unit,pcs,prc,ttl,tamm,eby,fst,tst,cgst_rt,sgst_rt,igst_rt,cgst_am,sgst_am,igst_am,net_am,refno,usl,betno,sec)
VALUES ('$srtnm','$total','$disp','$disa','$cat','$scat','$prnm','$unit','$pcs','$prc','$lttl','$tamm','$user_currently_loged','$fst','$tst','$cgst_rt','$sgst_rt','$igst_rt','$cgst_am','$sgst_am','$igst_am','$net_am','$refno','$usl','$betno','$sec')";
