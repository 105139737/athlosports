                ...
                <section class="content-header">
                   ...
                   <font > User</font>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i class="fa fa-user"></i>  User Update</li>
                    </ol>
                </section>
  ...
  <center>
    ...
    <input type="hidden" value="<?=$sl;?>" name="sl" id="sl">
          ...
          <tr>
            ...
            <input type="text" class="form-control" name="nm" id="nm" value="<?=$name;?>" size="20" required placeholder="Enter User Name" ></td>
            ...
            <input type="text" name="mob" id="mob" class="form-control" value="<?=$mob;?>" size="20" required placeholder="Enter Mobile"></td>
...
<td align="right" ><font color="red">*</font>Designation :</td>
<td align="left">
