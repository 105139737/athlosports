...
$('#data8').load('purchase_list.php?fdt='+fdt+'&tdt='+tdt+'&snm='+encodeURIComponent(snm)+'&brncd='+brncd+'&cat='+cat+'&scat='+scat+'&prnm='+prnm+'&godown='+godown+'&vstat='+vstat+'&ptyp='+ptyp).fadeIn('fast');
}
function edit(blno)
{
...
var prnm= document.getElementById('prnm').value;
var godown= document.getElementById('godown').value;
document.location='purchase_list_xls.php?fdt='+fdt+'&tdt='+tdt+'&snm='+encodeURIComponent(snm)+'&brncd='+brncd+'&cat='+cat+'&scat='+scat+'&prnm='+prnm+'&godown='+godown;
...
function verify(blno)
{
if (confirm("Are Sure ?")) 
{
$('#data8').load('purchase_verify.php?blno='+blno).fadeIn('fast');
}
}
function del(blno)
{
if (confirm("Are Sure To Delete This Invoice")) 
{
$('#data8').load('purchase_del.php?blno='+blno).fadeIn('fast');
}
}
...
<span style="display:none;"><a class="btn btn-primary" target="_blank" href="stk_mod.php">Bill Merge</a></span>
<input style="display:none;" type="button" class="btn btn-warning" value="Excel Export" onclick="xls()">
</td>
</tr>
</table>
