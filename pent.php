...
<tr>
	<td  align="right" style="padding-top:17px" width="20%"><font color="red">*</font><b>Category :</b></td>
	...
	<input type="text" class="form-control" id="pnm"  name="pnm" value=""  placeholder="Product Name... "  required>
	</td>   
</tr>
...
<tr >
	...
	<td  align="left" width="30%">
	<input type="text" class="form-control" name="sun" id="sun" value="" required   style="width:100%"  size="40" placeholder="Enter Small Unit....">
	</td>
