...
if($adj_typ=='1')
{
$query21 = "INSERT INTO ".$DBprefix."stock (pcd,bcd,dt,unit,stin,nrtn,eby,dtm,stat,ret,refno,usl,uval,betno,rate,stk_rate,sec)
VALUES ('$prnm','$brncd','$dt','$unit','$stock_in','Adjustment','$user_currently_loged','$dttm','1','$rate','Adjustment','$usl','$uval','$betno','$rate','$stk_rate','$sec')";
$result21 = mysqli_query($conn,$query21)or die (mysqli_error($conn)); 
}
else if($adj_typ=='0')
{
$query21 = "INSERT INTO ".$DBprefix."stock (pcd,bcd,dt,unit,stout,nrtn,eby,dtm,stat,ret,refno,usl,uval,betno,rate,stk_rate,sbill,sec)
VALUES ('$prnm','$brncd','$dt','$unit','$stock_in','Adjustment','$user_currently_loged','$dttm','1','$rate','Adjustment','$usl','$uval','$betno','$rate','$stk_rate','Adjustment','sec')";
$result21 = mysqli_query($conn,$query21)or die (mysqli_error($conn)); 
}
...
document.location="stk_adjust.php";
</script>
<?
}
else
