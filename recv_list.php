...
$sl=$start;
$sln=0;
$datatt= mysqli_query($conn,"SELECT * FROM main_drcr where typ='77' and stat='1'".$pnoo.$brncd1)or die(mysqli_error($conn));
$rcntttl=mysqli_num_rows($datatt);
$datar= mysqli_query($conn,"SELECT * FROM main_drcr where typ='77' and stat='1'".$pnoo.$brncd1)or die(mysqli_error($conn));
$rcnt=mysqli_num_rows($datar);
 $data= mysqli_query($conn,"SELECT * FROM main_drcr where typ='77' and stat='1' $pnoo $brncd1 order by dt Desc,sl desc limit $start,$ps")or die(mysqli_error($conn));
	...
	<td align="left" valign="top"><a href="#" title="By : <?php echo $eby;?> | On :<?=$edt;?>"><b><?php echo $f;?></b></td>
    <td align="left" valign="top"><b>Date :</b> <?php echo $dt;?><br><b>JF No. :</b> <?php echo $vno;?></td>
    <td align="left" valign="top"><b>C.Ledger :</b> <?php echo $spn;?><br><b>D.Ledger :</b> <?php echo $dldgr;?></td>
	...
	<a href="cash_report.php?sl=<?php echo $sl1;?>" target="_blank" title="Click Here To Print Voucher"><i class="fa fa-print fa-2x" style="color:#333333;"></i></a>
	</td>
