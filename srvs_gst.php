...
/* 		else if(refno=='')
	...
	$('#wb_Text13').load('adtmppr_ser.php?catg='+catg+'&prnm='+prnm+'&unit='+unit+'&pcs='+pcs+'&prc='+prc+'&total='+total+'&disp='+disp+'&disa='+disa+'&lttl='+lttl+'&brncd='+brncd+'&fst='+fst+'&tst='+tst+'&cgst_rt='+cgst_rt+'&sgst_rt='+sgst_rt+'&igst_rt='+igst_rt+'&cgst_am='+cgst_am+'&sgst_am='+sgst_am+'&igst_am='+igst_am+'&refno='+encodeURIComponent(refno)+'&usl='+usl+'&betno='+betno+'&sec='+sec).fadeIn('fast');
		}
...
function temp()
{
$('#wb_Text13').load("tmppr_gst_ser.php").fadeIn('fast');
//$('#fst_div').load("fst_get1.php").fadeIn('fast');
$('#tst_div').load("tst_get_ser.php").fadeIn('fast');
$('#sec_div').load("div_sec_ser.php").fadeIn('fast');
}
function deltpr(un,sl)
{
$('#wb_Text13').load("deltpr_ser.php?sl="+sl+"&tsl="+un).fadeIn('fast');
}
function t()
	{

	$('#billamm').load('stotal-gst_ser.php').fadeIn('fast');
	$('#gst_am').load('gst_am_ser.php').fadeIn('fast');
	}
...
<form method="post" target="" name="form1" id="form1"  action="srvs_gsts.php">
...
<tr class="odd">
<td  align="left" width="12%"><b>Category</b></td>
<td  align="left" width="13%"><b>Product</b></td>

<td  align="center" width="5%"><b>Unit</b></td>
<td align="center" width="5%" hidden><b>Stock In Hand</b></td>

<td  align="left" width="4%"><b>Sl.No.</b></td>
