...
$('#sgh').load('prod_wise_stks.php?pnm='+pnm+'&brncd='+brncd+'&cat='+cat+'&dt='+dt).fadeIn('fast');
}
function pagnt(pno)
{
...
var pnm= document.getElementById('prnm').value;
var dt= document.getElementById('dt').value;
$('#sgh').load("prod_wise_stks.php?ps="+ps+"&pno="+pno+"&pnm="+pnm+"&brncd="+brncd+"&cat="+cat+'&dt='+dt).fadeIn('fast');
$('#pgn').val=pno;
}
...
{
var cat=document.getElementById('cat').value;
$("#prod_div").load("getmodel_psw.php?cat="+cat).fadeIn('fast');	
}
            ...
            <aside class="right-side">
                ...
                Product Wise Stock Statement 
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Product Wise Stock Statement </li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <!-- Main row -->
                     ...
                     <!-- /.box (chat box) -->
                            ...
                            <!-- TO DO List -->
<form method="post" action="prod_wise_stks_xls.php" id="form1" onSubmit="return check1()" name="form1">
