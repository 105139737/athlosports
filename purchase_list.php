...
$tigst_am=0;
$tgst=0;
$data= mysqli_query($conn,"select * from  main_purchasedet where sl>0 and blno='$blno' $catsl1 $prnm1 order by sl")or die(mysqli_error($conn));
...
if($blno1==$blno)	
{
	...
	{
	?>
	<small class="badge pull-right bg-green">Veryfied</small>
