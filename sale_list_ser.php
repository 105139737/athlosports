...
$cgst1=0;
$sgst1=0;
$data1= mysqli_query($conn,"select * from  main_ser_billing where sl>0".$todts.$snm1.$brncd1.$invtyp1.$sec1." order by dt,sl")or die(mysqli_error($conn));
...
$total_am=0;
$disa_am=0;
$data= mysqli_query($conn,"select * from  main_ser_billdtls where sl>0 and blno='$blno' $catsl1 $prnm1 order by sl")or die(mysqli_error($conn));
