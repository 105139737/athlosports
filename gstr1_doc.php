...
function show1()
{
 ...
 $('#data8').load('gstr1_docs.php?fdt='+fdt+'&tdt='+tdt+'&ndoc='+encodeURI(ndoc)).fadeIn('fast');
...
document.location='gstr1_doc_csv.php?fdt='+fdt+'&tdt='+tdt+'&ndoc='+encodeURI(ndoc);
}
</script>
            ...
            <aside class="right-side">
              ...
              GSTR-1 DOCS
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"> GSTR-1 DOCS </li>
                    </ol>
                </section>
...
<td align="left" width=""  >
<b> Nature of Document:</b>
<br>
<select id="ndoc" name="ndoc" class="form-control">
<option value="Invoice For Outward Supply">Invoice For Outward Supply</option>
</select>
</td>
