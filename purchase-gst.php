...
lttl=(total-(disa1+ldisa1)).round(3);
	...
	net_amm=(sgst+cgst+igst+lttl).round(2);
...
function add()
{
		...
		var bcd=document.getElementById('brncd').value;
...
{
prnm=document.getElementById('prnm').value;	
$("#g_gwn").load("get_gwn_pur.php?prnm="+prnm).fadeIn('fast');	
}
...
<body onload="tmppr1()" >
  ...
  <tr>
  <td align="right" style="padding-top:15px;width:15%;"><b>Company Name :</b>
  </td>
  ...
  <tr>
   <td align="right" style="padding-top:15px;width:15%;"><b>Address : </b></td>
...
<div id="get_add">
 <input type="tex"  class="form-control" tabindex="2"  style="font-weight: bold;" id="addr" name="addr" value=""  placeholder="Customer Address">
   ...
   <td align="right" style="padding-top:15px;width:15%;"><b>Contact No. :</b></td>
...
?>
  ...
  <td>
  <input type="text" class="form-control" tabindex="6"  id="inv"  name="inv" value="" required size="35" placeholder="Enter Invoice No...">
  </td>
...
<tr>
<td align="right" style="padding-top:15px;"> <b>Consinee : </b></td>
<td>
...
<td align="right" style="padding-top:15px;" width="15%"><b>Ship TO Customer :</b></td>
<td colspan="" width="35%"> 
<select id="custnm" name="custnm" tabindex="1" class="form-control" >
<option value="">---Select---</option>
<?
...
<td align="center" width="10%" ><b>Product</b></td>
<td align="center" width="5%" ><b>Unit</b></td>
<td align="center" width="7%"  style="display:none;"><b>Serial No.</b></td>
...
<td>
<input type="text" id="qnty" class="sc" tabindex="13"  autocomplete="off" style="text-align:center" name="qnty" value="" onblur="cal()" onkeypress="return isNumber1(event)" >
</td>
<td>
...
<span style="color:#000;padding-right:30px;display:none;" > 
