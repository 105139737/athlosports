...
<div class="row">
<div class="col-md-12">
<div class="col-md-12" style="background-color:#000"><font size="5" color="#fff">Service Details</font></div>
...
$cgst1=0;
$sgst1=0;
$data1= mysqli_query($conn,"select * from  main_ser_billing where sl>0".$todts.$snm1.$brncd1.$invtyp1." order by dt,sl")or die(mysqli_error($conn));
...
$total_am=0;
$disa_am=0;
$data= mysqli_query($conn,"select * from  main_ser_billdtls where sl>0 and blno='$blno' $catsl1 $prnm1")or die(mysqli_error($conn));
	...
	if($blno==$blno1)
	{
		$asd++;
		 ...
		 ?>
			...
			<?if($cstat==0){?>	
			<a href="billing_ret.php?blno=<?=rawurlencode($blno);?>"><i class="fa fa-reply-all" style="color:red;"></i></a>
			<?}?>
			</td>
