...
var sec= document.getElementById('sec').value;
 $('#data8').load('sale_list.php?fdt='+fdt+'&tdt='+tdt+'&snm='+encodeURIComponent(snm)+'&cat='+cat+'&prnm='+prnm+'&brncd='+brncd+'&invtyp='+invtyp+'&sec='+sec).fadeIn('fast');
...
var prnm= document.getElementById('prnm').value;
var sec= document.getElementById('sec').value;
document.location='sale_xls.php?fdt='+fdt+'&tdt='+tdt+'&snm='+encodeURIComponent(snm)+'&cat='+cat+'&prnm='+prnm+'&brncd='+brncd+'&invtyp='+invtyp+'&sec='+sec;
}
function view(blno)
{
