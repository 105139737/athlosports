...
$sl=$start;
$sln=0;
$datatt= mysqli_query($conn,"SELECT * FROM main_drcr where typ='C01' and stat='1'".$brncd1)or die(mysqli_error($conn));
$rcntttl=mysqli_num_rows($datatt);
$datar= mysqli_query($conn,"SELECT * FROM main_drcr where typ='C01' and stat='1'".$brncd1)or die(mysqli_error($conn));
$rcnt=mysqli_num_rows($datar);
 $data= mysqli_query($conn,"SELECT * FROM main_drcr where typ='C01' and stat='1' $brncd1 order by dt Desc limit $start,$ps")or die(mysqli_error($conn));
  ...
  <td align="left" valign="top"><a href="#" title="By : <?=$eby;?> | On :<?=$edt;?>"><b><?echo $f;?></b></td>
    ...
    <td align="left" valign="top"><b>C.Ledger :</b> <?echo $cldgr;?><br><b>D.Ledger :</b> <?echo $cnm;?></td>
	 ...
	 <td align="left" valign="top"><b>Ref. : </b><?echo $mtddtl;?></td>
...
<td align="center" valign="top"><?php if($path!=""){echo "<a href='$path' target='_blank'>Click to Download</a>";};?></td>
	...
	<a href="crdt_note_edt.php?csl=<?=$sl1;?>" title="Edit"><img src="images/edit.png" width="30"/></a>
