...
function show1()
{
 ...
 $('#data8').load('gst_b2cs_list.php?fdt='+fdt+'&tdt='+tdt).fadeIn('fast');
}
	function xls()
{
 ...
 var fdt= document.getElementById('fdt').value;
 var tdt= document.getElementById('tdt').value;
//document.location='gst_b2cs_xls.php?fdt='+fdt+'&tdt='+tdt;
document.location='gst_b2cs_csv.php?fdt='+fdt+'&tdt='+tdt;
}
</script>
 ...
 <body>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1 align="center">
              GSTR-1 B2C(Small) Report
                      
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li class="active"> GSTR-1 B2C(Small)</li>
                    </ol>
                </section>
