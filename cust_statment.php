 ...
 function stat()
{
   ...
   var sl= document.form1.cid.value;window.open('custenq.php?sl='+sl+'&fdt='+fdt+'&tdt='+tdt+'&proj='+proj,'_blank');
   }
</script>
...
<tr>
<td align="leftt"  style="padding-top:10px"> <font size="3"><b>Customer Name :</b></font></td>
<td align="left">
<select id="cid"  name="cid"  tabindex="2" class="sc" style="width:300px" onchange="sto1(this.value)" >	
	<option value="">---Select---</option>		
	<?		
	$query6="select * from  main_cust ";		
	$result5 = mysqli_query($conn,$query6);		
	while($row=mysqli_fetch_array($result5))		
		{			
	?>		
	<option value="<?=$row['sl'];?>"<?=$sto==$row['sl'] ? 'selected' : ''?>><?=$row['nm'];?> - <?=$row['cont'];?></option>	
	<?}?>		
	</select>
	<input type="hidden" name="proj" id="proj" value="NA" readonly>
</td>

<td align="right" style="padding-top:10px"> <font size="3" ><b>From  :</b></font></td>
<td align="left"><input type="text" name="fdt" id="fdt" class="sc" value="<?=$fdt;?>" style="width:100px"></td>
<td align="right" style="padding-top:10px"> <font size="3" ><b>To  :</b></font></td>
<td align="left"><input type="text" name="tdt" id="tdt" class="sc" value="<?=$tdt;?>" style="width:100px"></td>
</tr>
<tr>
