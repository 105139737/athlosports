...
$("#get_cat_div").load("get_cat_div.php?sec="+sec).fadeIn('fast');
}
...
var sec= document.getElementById('sec').value;
 $('#data8').load('sale_list_ser.php?fdt='+fdt+'&tdt='+tdt+'&snm='+encodeURIComponent(snm)+'&cat='+cat+'&prnm='+prnm+'&brncd='+brncd+'&invtyp='+invtyp+'&sec='+sec).fadeIn('fast');
...
var prnm= document.getElementById('prnm').value;
var sec= document.getElementById('sec').value;
document.location='sale_xls_ser.php?fdt='+fdt+'&tdt='+tdt+'&snm='+encodeURIComponent(snm)+'&cat='+cat+'&prnm='+prnm+'&brncd='+brncd+'&invtyp='+invtyp+'&sec='+sec;
}
function view(blno)
{

window.open('bill_new_gst_ser.php?blno='+encodeURIComponent(blno), '_blank');
window.focus();
}
/* 
function dlt(blno)
...
<select name="invtyp" class="form-control" id="invtyp">
<option value="0">Invoice</option>
<option value="1">Canceled Invoice</option>
...
<td width="15%">
<b>Section:</b>
<select id="sec" name="sec" class="form-control czn" onchange="get_cat_div()">
<option value="">---All---</option>
<?
