...
<?
$cnt=0;
$sql=mysqli_query($conn,"select * from main_stock where sl>0 $pnm1 $bcd $betno1 order by dt") or die (mysqli_error($conn));
...
$pnm=$row1['pnm'];
	...
	<tr bgcolor="">
			...
			<td  align="center"><b><?echo $pbill;?></b></td>
			<td  align="center"><b><a href="#" onclick="view('<?=$sbill;?>')" title="Print"><?=$sbill;?></a></b></td>
			
			<td  align="center" ><b><?echo $prbill;?></b></td>
			<td  align="center" ><b><a href="#" onclick="view1('<?=$rbill;?>')" title="Print"><?=$rbill;?></a></b></td>
