            ...
            <aside class="right-side">
               ...
               Category 
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
						<a href="tech_show.php"><i class="fa fa-list"></i>Category Update</a></li>
                    </ol>
                </section>
...
<input type="hidden" name="sl" id="sl" value="<?=$sl;?>">
            ...
            <input type="text" class="form-control" name="cat" value="<?=$cnm;?>" id="cat"  size="40" placeholder="Enter  Company..." required>
			</td>
			<td  colspan=""  align="center" style="padding-right: 5px;">
