...
$('#data8').load('purchase_list_ret.php?fdt='+fdt+'&tdt='+tdt+'&snm='+encodeURIComponent(snm)+'&brncd='+brncd+'&cat='+cat+'&scat='+scat+'&prnm='+prnm+'&godown='+godown+'&vstat='+vstat+'&ptyp='+ptyp).fadeIn('fast');
}
...
var prnm= document.getElementById('prnm').value;
var godown= document.getElementById('godown').value;
document.location='purchase_list_xls_ret.php?fdt='+fdt+'&tdt='+tdt+'&snm='+encodeURIComponent(snm)+'&brncd='+brncd+'&cat='+cat+'&scat='+scat+'&prnm='+prnm+'&godown='+godown;
