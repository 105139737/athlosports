...
<td width="50%">
<b>Tax Rate(%) :</b>
<input type="text" name="tax_rate" id="tax_rate" class="form-control" value="" onkeypress="return isNumber(event)">
</td>
<td  width="50%">
<b>Tax Amount :</b>
<input type="text" name="tax" id="tax" class="form-control" value="" onblur="cal()" required onkeypress="return isNumber(event)">
</td>
</tr>
</table>
</td>
...
<td align="left" >
<b>Net Amount :</b>
<input type="text" name="net" id="net" class="form-control" value="" onblur="cal()" required onkeypress="return isNumber(event)">
</td>
</tr>
