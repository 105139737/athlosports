...
<table style="border-collapse:collapse; border: 1px solid black; width:100%;">
<tr>
<td style="text-align:left; border: 1px solid black; width:55%;">
...
<td style="text-align:left; border: 1px solid black; width:45%;">
<table style="width:100%;">
<tr>
...
<td style="text-align:left;" ><font size="2"><?=$pnm;?>
<?if($betno!=''){?>
<br>
Sl. No. - <?=$betno;}?>
</font></td>
