...
$(document).ready(function()
{
   ...
   $("#dt").datepicker(jQueryDatePicker1Opts);
	...
	var brncd= document.getElementById('brncd').value;
		...
		sh();
				...
				function sh()
			{
				proj = document.getElementById('proj').value;
				var brncd= document.getElementById('brncd').value;
				$('#show').load('exp_list.php?pno1='+proj+'&brncd='+brncd).fadeIn('fast');
			}
    ...
    $('#show').load("exp_list.php?ps="+ps+"&pnog="+pnog+"&pno1="+proj+'&brncd='+brncd).fadeIn('fast');
	$('#pgn').val=pnog;
    }
...
<td align="left">
<select name="brncd" class="form-control" size="1" id="brncd"  onchange="gtcrvl1();gtdrvlfi()" >
<?
...
<td align="left" >
<select  name="proj" id="proj" class="form-control" onchange="gtcrvl1();gtdrvlfi()">
