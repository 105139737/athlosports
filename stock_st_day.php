...
<script type="text/javascript" src="prdcedt.js"></script>
 ...
 $('#sgh').load('stock_sts_day.php?pnm='+pnm+'&dt='+dt+'&brncd='+brncd+'&cat='+cat+'&scat='+scat+'&stat='+stat).fadeIn('fast');
...
function exp()
{
  var dt= document.getElementById('dt').value;
	...
	document.location='stock_sts_xls_day.php?pnm='+pnm+'&dt='+dt+'&brncd='+brncd+'&cat='+cat+'&bnm='+bnm;
}
...
$("#prod_div").load("get_product_stk.php?cat="+cat+"&scat="+scat).fadeIn('fast');
 }
 function get_prod()
 {
cat=document.getElementById('cat').value;
                ...
                <section class="content">
                    ...
                    <!-- Main row -->
                     ...
                     <!-- /.box (chat box) -->
                            ...
                            <!-- TO DO List -->
 	<form method="post" action="stock_sts_day_excel.php" id="form1" onSubmit="return check1()" name="form1">              
<input type="hidden">
  <center>
...
<b>Date : </b>
<input type="text" id="dt" name="dt" value="<?=date('d-m-Y');?>" class="form-control" >
...
?>
 ...
 <td  align="left" width="20%" hidden>
  <b>Category :</b><br>
  <div id="scat_div">
<select name="scat" class="form-control" size="1" id="scat" tabindex="8"  onchange="getv()" >
<Option value="">---All---</option>
<?
