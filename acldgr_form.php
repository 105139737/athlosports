...

{
   ...
   $("#dt").datepicker(jQueryDatePicker1Opts);
    ...
    $('#show').load("acldgr_form_list.php?ps="+ps+"&pnog="+pnog).fadeIn('fast');
...
<input type="hidden" name="flnm" id="flnm" value="income.php" >
 ...
 <tr class="odd">
    ...
    <td align="left" width="30%"><select  name="acgrp" style="width:300px" class="form-control">
    ...
    <td align="left" width="30%">
      ...
      <input type="text" name="acldgr" id="acldgr" size="40" class="form-control">
