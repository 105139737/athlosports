...
var prnm=document.getElementById('prnm').value;	
var brncd=document.getElementById('brncd').value;	
$("#show").load("stk_adjust_show.php?cat="+cat+"&prnm="+prnm+"&brncd="+brncd).fadeIn('fast');	
 }
...
$('#show').load("stk_adjust_show.php?ps="+encodeURI(ps)+"&pno="+encodeURI(pno)+"&cat="+cat+"&prnm="+prnm+"&brncd="+brncd).fadeIn('fast');
$('#pgn').val=pno;
}
...
<form method="post" action="stk_adjusts.php" id="form1" onSubmit="return check1()" name="form1">
<div class="box box-success" >
<table border="0" width="860px" class="table table-hover table-striped table-bordered">
<tr>
<td  align="right" width="20%"><b>Section :</b></td>
<td width="30%" >
<select id="sec" name="sec" class="form-control" onchange="get_cat_div()">
...
<td width="30%" >
  <div id="get_cat_div">
<select name="cat" class="form-control" id="cat" onchange="get_prod();show()">
<Option value="">---Select---</option>
<?
...
<td>
<div id="prod_div">
<select name="prnm" class="form-control"  id="prnm"  onchange="gtt_unt();getstock();gtt_godwn();show();get_igst()" >
<option value="">---All---</option>
<?
$data13 = mysqli_query($conn,"Select * from main_product where typ='0' order by pnm");
while ($row13 = mysqli_fetch_array($data13))
{
$psl=$row13['sl'];
$pnm=$row13['pnm'];
?>
<Option value="<?=$psl;?>"><?=reformat($pnm);?></option>
<?
}
?>
</select>
...
$query="Select * from main_branch order by bnm";
...
<td>
<input type="text" name="rate" id="rate" class="form-control" onkeypress="return isNumber(event)" onblur="get_wo_gst()">
</td>
<td align="right"><b>Without GST Rate  :</b></td>

<td>
<input type="text" name="stk_rate" id="stk_rate" class="form-control" onkeypress="return isNumber(event)" onblur="get_w_gst(this.value)">
</td>
</tr>
<tr>
