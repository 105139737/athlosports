...
<th align="center" width="15%">Date & JF No.</th>
<th align="center" width="25%">Credit Ledger &<br>Debit Ledger</th>
<th align="center" width="15%">Ammount <br>& Project</th>
...
$sl=$start;
$sln=0;
$datatt= mysqli_query($conn,"SELECT * FROM main_drcr where typ='44' and stat='1'".$brncd1.$pnoo)or die(mysqli_error($conn));
$rcntttl=mysqli_num_rows($datatt);
$datar= mysqli_query($conn,"SELECT * FROM main_drcr where typ='44' and stat='1'".$pnoo.$brncd1)or die(mysqli_error($conn));
$rcnt=mysqli_num_rows($datar);
$data= mysqli_query($conn,"select * from main_drcr where typ='44' and stat='1' $pnoo $brncd1 order by dt Desc limit $start,$ps")or die(mysqli_error($conn));
...
<a href="#" onclick="sfdtl3expn('<? echo $sl1; ?>')" title="Edit"><img src="images/edit.png" width="30"/></a>
	</td>
	 </tr>
  <?
  }
