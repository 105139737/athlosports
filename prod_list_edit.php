...
<td align="left" width="30%">
	...
	<td  align="right" style="padding-top:17px"><font color="red">*</font><b>Product Name :</b></td>
...
<tr>
	...
	<td  align="right" style="padding-top:15px"><b>GST :</b></td>
	<td  align="left">
	<div id="igdiv">
	<input type="text" class="form-control" id="igst" name="igst" value="<?php echo $igst;?>" placeholder="Enter GST" required onkeypress="return isNumber(event)">
	</div>
	</td>	
...
<tr>
	...
	<td  align="left" width="30%">
	<input type="text" class="form-control" name="sun" id="sun" value="<?php echo $sun;?>" onblur="unit()" style="width:100%"  size="40" placeholder="Enter Small Unit....">
	</td>
...
<tr> 
	...
	<input type="text" class="form-control" name="mun" id="mun" onblur="unit()" value="<?php echo $mun;?>" size="40" placeholder="Enter Midle Unit...." >
	</td>
