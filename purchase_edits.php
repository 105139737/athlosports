...
adlv='$adlv',tmm2='$tamm2',remk='$remk',sttl='$sttl',cbnm='$cbnm' WHERE blno='$blno'";
...
if($unit=='mun'){$stock_in=$qty*$mdvlu;$uval=$mdvlu;$rate1=$rate/$mdvlu;$uval=$mdvlu;$stk_rate=$stk_rate1/$mdvlu;}
if($unit=='bun'){$stock_in=$qty*$bgvlu;$uval=$bgvlu;$rate1=$rate/$bgvlu;$uval=$bgvlu;$stk_rate=$stk_rate1/$bgvlu;}
