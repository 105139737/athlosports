...
$("#"+div).load("gisedts.php?sl="+sl+"&fn="+fn+"&fv="+encodeURI(fv)+"&div="+div+"&tblnm="+tblnm).fadeIn('fast');
 ...
 <script type="text/javascript" src="js2.js" ></script>
		...
		<tr>
		<th>Name</td><td><font color="#000000">
<div id="name<?=$sl;?>">
<a  onclick="sedt('<?echo $sl;?>','name','<?echo $name;?>','name<?=$sl;?>','main_signup')"><b><? echo $name;?></font></b></a>
 </div> 
		...
		<tr>
		<th>Mobile No.</th><td align="center"><font color="#000000">
		
		<div id="mob<?=$sl;?>">
<a  onclick="sedt('<?echo $sl;?>','mob','<?echo $mob;?>','mob<?=$sl;?>','main_signup')"><b><? echo $mob;?></font></b></a>
 </div> 
		</font></td></tr>
		<tr>
		<th>Email</th><td><font color="#000000">
		
				<div id="mailadres<?=$sl;?>">
<a  onclick="sedt('<?echo $sl;?>','mailadres','<?echo $mailadres;?>','mailadres<?=$sl;?>','main_signup')"><b><? echo $mailadres;?></font></b></a>
 </div> 
