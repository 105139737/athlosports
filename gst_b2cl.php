...
function show1()
{
 ...
 $('#data8').load('gst_b2cl_list.php?fdt='+fdt+'&tdt='+tdt+'&snm='+snm).fadeIn('fast');
	...
	function xls()
{
 ...
 var tdt= document.getElementById('tdt').value;
  var snm= document.getElementById('snm').value;
//document.location='gst_b2cl_xls.php?fdt='+fdt+'&tdt='+tdt+'&snm='+snm;
document.location='gst_b2cl_csv.php?fdt='+fdt+'&tdt='+tdt+'&snm='+snm;
}
</script>
 ...
 <body>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1 align="center">
              GSTR-1 B2C(Large) Report
                      
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li class="active"> GSTR-1 B2C(Large)</li>
                    </ol>
                </section>
