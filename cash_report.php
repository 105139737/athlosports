...
if($pno=='0')
{
$data= mysqli_query($conn,"SELECT sum(amm) as t1 FROM main_drcr where dldgr='4' and stat='1' and cid='$cid'");
}
else
{
$data= mysqli_query($conn,"SELECT sum(amm) as t1 FROM main_drcr where dldgr='4' and pno='$pno' and stat='1' and cid='$cid'");
}
...
if($pno=='0')
{
$data1= mysqli_query($conn,"SELECT sum(amm) as t2 FROM main_drcr where cldgr='4' and stat='1' and cid='$cid'");
}
else
{
$data1= mysqli_query($conn,"SELECT sum(amm) as t2 FROM main_drcr where cldgr='4' and pno='$pno' and stat='1' and cid='$cid'");
}
...
<tr>
    <td colspan="5">
        ...
        <tr>
            ...
            <td style="width:20%; padding-left:5px;"><?=$vno?></td>
        ...
        <tr>
            ...
            <td colspan="3" style="width:20%; padding-left:5px;"><b><?php echo $nm;?></b> , <?php echo $addr;?> </td>
        </tr>
        </table>
    </td>
</tr>
<tr style="height:50px;">
    <td colspan="5">
		...
		<tr>
            ...
            <td style="text-align:left;font-size:22px;"><?php echo $cbill;?></td>
            <td style="text-align:right;font-size:22px;"><b>Outstanding :</b></td>
            <td style="text-align:left; font-size:22px;"><?=$T;?></td>
        </tr>
		<tr>
            <td style="text-align:right;font-size:22px;"><b>Narration :</b></td>
            <td style="text-align:left;font-size:22px;" colspan="3"><?php echo $nrtn;?></td>
        </tr>
