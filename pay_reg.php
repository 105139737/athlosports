...
function gtcrvl1()
	...
	function sh()
			{
				var brncd= document.getElementById('brncd').value;
				proj = document.getElementById('proj').value;
				$('#show').load('pay_list.php?pno1='+proj+'&brncd='+brncd).fadeIn('fast');
    ...
    $('#show').load("pay_list.php?ps="+ps+"&pnog="+pnog+"&pno1="+proj+'&brncd='+brncd).fadeIn('fast');
	$('#pgn').val=pnog;
    }
...
<tr>
<td align="right" ><font color="red">*</font>Upload File :</td>
<td align="left" >
