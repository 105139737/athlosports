...
$query111 = "SELECT * FROM ".$DBprefix."ser_billing where blno='$blno'";
...
<font style="font-size:18px;"><b>Dealers In : New Tyer Tube & Accessories</b></font><br/>
...
$pnm1="";
$total_qty=0;
$data= mysqli_query($conn,"select *,sum(pcs) as pcs,sum(cgst_am) as cgst_am,sum(sgst_am) as sgst_am,sum(igst_am) as igst_am from  main_ser_billdtls where sl>0 and blno='$blno' group by prsl,prc")or die(mysqli_error($conn));
...
$betno1="";
$data1= mysqli_query($conn,"select * from  main_ser_billdtls where sl>0 and blno='$blno' and prsl='$pcd' and prc='$prc'")or die(mysqli_error($conn));
